...
void test_suggestor_prefers_project_for_repeated_rows() {
  ...
  auto suggestion = markql::cli::suggest_markql_statement(doc, 2);
  expect_true(suggestion.strategy == markql::cli::MarkqlSuggestionStrategy::Project,
...
void test_suggestor_falls_back_to_flatten_for_weak_shape() {
  ...
  auto suggestion = markql::cli::suggest_markql_statement(doc, 0);
  expect_true(suggestion.strategy == markql::cli::MarkqlSuggestionStrategy::Flatten,
