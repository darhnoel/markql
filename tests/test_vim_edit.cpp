...
void test_vim_x_deletes_single_ascii() {
  ...
  bool changed = markql::cli::delete_vim_chars_under_cursor(buffer, cursor, 1);
...
void test_vim_count_x_deletes_multiple_ascii() {
  ...
  bool changed = markql::cli::delete_vim_chars_under_cursor(buffer, cursor, 3);
...
void test_vim_count_x_clamps_at_eof() {
  ...
  size_t cursor = 1;  // on 'b'
  bool changed = markql::cli::delete_vim_chars_under_cursor(buffer, cursor, 99);
...
void test_vim_word_forward_small_vs_big() {
  ...
  size_t small = markql::cli::move_vim_word_forward_n(buffer, 0, 1, false);
  size_t big = markql::cli::move_vim_word_forward_n(buffer, 0, 1, true);
...
void test_vim_word_backward_small_vs_big() {
  std::string buffer = "foo,bar baz";
  size_t small = markql::cli::move_vim_word_backward_n(buffer, 8, 1, false);
  size_t big = markql::cli::move_vim_word_backward_n(buffer, 8, 1, true);
...
void test_vim_delete_motion_dw() {
  ...
  size_t cursor = 0;
  bool changed = markql::cli::delete_vim_motion(buffer, cursor, 1, 'w', buffer.size());
...
void test_vim_delete_motion_db() {
  ...
  bool changed = markql::cli::delete_vim_motion(buffer, cursor, 1, 'b', buffer.size());
...
void test_vim_delete_motion_dollar() {
  ...
  bool changed = markql::cli::delete_vim_motion(buffer, cursor, 1, '$', buffer.size());
...
void test_vim_delete_motion_unknown_is_noop() {
  std::string buffer = "abc";
  size_t cursor = 1;
  bool changed = markql::cli::delete_vim_motion(buffer, cursor, 1, 'q', buffer.size());
