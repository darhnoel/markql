...
void test_fuzzy_search_orders_and_snippet() {
  ...
  auto matches = markql::cli::fuzzy_search_inner_html(doc, "target", 10);
...
void test_fuzzy_search_candidate_subset() {
  ...
  auto matches = markql::cli::fuzzy_search_inner_html(doc, "target", 10, false, false, &candidates);
...
void test_fuzzy_search_prioritizes_word_level_match() {
  ...
  auto matches = markql::cli::fuzzy_search_inner_html(doc, "flight", 10, false, true);
...
void test_exact_search_case_insensitive_contiguous_only() {
  ...
  auto matches = markql::cli::exact_search_inner_html(doc, "target", 10, false, true);
...
void test_exact_search_prioritizes_whole_word() {
  ...
  auto matches = markql::cli::exact_search_inner_html(doc, "flight", 10, false, true);
