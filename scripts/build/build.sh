...
: "${MARKQL_BUILD_CLI:=ON}"
: "${MARKQL_BUILD_TESTS:=ON}"
: "${MARKQL_BUILD_PYTHON:=OFF}"
: "${MARKQL_AGENT_FETCH_DEPS:=ON}"
: "${MARKQL_ENABLE_KHMER_NUMBER:=ON}"
: "${MARKQL_WITH_LIBXML2:=ON}"
...
cmake_args=(
  ...
  "-DMARKQL_BUILD_CLI=${MARKQL_BUILD_CLI}"
  "-DMARKQL_BUILD_TESTS=${MARKQL_BUILD_TESTS}"
  "-DMARKQL_BUILD_PYTHON=${MARKQL_BUILD_PYTHON}"
  "-DMARKQL_WITH_LIBXML2=${MARKQL_WITH_LIBXML2}"
  "-DMARKQL_WITH_NLOHMANN_JSON=${MARKQL_WITH_NLOHMANN_JSON}"
  "-DMARKQL_WITH_CURL=${MARKQL_WITH_CURL}"
  "-DMARKQL_WITH_ARROW=${MARKQL_WITH_ARROW}"
  "-DMARKQL_BUILD_AGENT=${MARKQL_BUILD_AGENT}"
  "-DMARKQL_AGENT_FETCH_DEPS=${MARKQL_AGENT_FETCH_DEPS}"
  "-DMARKQL_ENABLE_KHMER_NUMBER=${MARKQL_ENABLE_KHMER_NUMBER}"
