...
const std::vector<std::string>& markql_completion_keywords() {
  static const std::vector<std::string> keywords = {"select",
                                                    "from",
                                                    "where",
                                                    "and",
                                                    "or",
...
bool is_sql_keyword_token(std::string_view word) {
  ...
  static const std::unordered_set<std::string> keywords(markql_reserved_keywords().begin(),
                                                        markql_reserved_keywords().end());
  std::string lower;
